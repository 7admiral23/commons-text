...
public class ScriptStringLookup_ESTest extends ScriptStringLookup_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        scriptStringLookup0.lookup("org.apache.commons.text.lookup.AbstractStringLookup");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Bad script key format [org.apache.commons.text.lookup.AbstractStringLookup]; expected format is EngineName:Script.
         //
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        scriptStringLookup0.lookup("pjobWOxrGr<:E");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Error in script engine [pjobWOxrGr<] evaluating script [E].
         //
         verifyException("org.apache.commons.text.lookup.IllegalArgumentExceptions", e);
      }
  }
